<template>
    <div class="panel">
        <el-container class="full-height">
            ...
            <el-main class="panel-body no-padding lum-scrollbar">
                ...
                <template v-if="status == 1">
                    ...
                    >
                        <el-avatar class="avatar" shape="square" :size="35" :src="item.avatar">
                        ...
                        <div class="card">
                            <div class="title">
                                ...
                                <div v-show="item.leader == 2" class="larkc-tag wait">群主</div>
                            </div>
                            <div class="content">
                                [群介绍] ~ 「{{
        ...
        <div v-show="groupDetailId" class="broadside-box">
            <group-panel
...
export default {
    ...
    methods: {
        ...
        disturbChange(detail) {
            const index = this.getGroupIndex(detail.group_id);
