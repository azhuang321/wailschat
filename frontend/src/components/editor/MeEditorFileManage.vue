...
export default {
    ...
    methods: {
        ...
        triggerUpload (hashName) {
            ...
            const i = this.items[$index].successNum;
            const form = this.items[$index].forms[i];
            const length = this.items[$index].forms.length;
        ...
        removeFile (hashName) {
            const index = this.getFileIndex(hashName);
