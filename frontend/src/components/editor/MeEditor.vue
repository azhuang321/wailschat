<template>
    <div>
        <el-container class="editor-container">
            <el-header class="no-padding toolbar" height="35px">
                ...
                <form ref="fileFrom" enctype="multipart/form-data" style="display: none">
                    ...
                    />
                    <input ref="restFile2" type="file" @change="uploadFileChange" />
                </form>
            </el-header>
        ...
        <MeEditorRecorder v-if="recorder" @close="recorder = false" @send="sendRecorder" />
...
import MeEditorFileManage from './MeEditorFileManage.vue';
import MeEditorImageView from './MeEditorImageView.vue';
import MeEditorRecorder from './MeEditorRecorder.vue';
import MeEditorVote from './MeEditorVote.vue';
import MeEditorLocation from './MeEditorLocation.vue';
import TalkCodeBlock from '@/components/chat/TalkCodeBlock.vue';
import { getPasteImgs, getDragPasteImg } from '@/utils/editor';
import { findTalk } from '@/utils/talk';

import { ServeSendTalkCodeBlock, ServeSendTalkImage, ServeSendEmoticon } from '@/api/chat';
