...
// import Vue from 'vue';
// import vm from '@/main';
import NewMessageNotify from '@/components/notify/NewMessageNotify.vue';
...
class Talk extends Base {
   ...
   */
  getFloatType () {
    const user_id = this.resource.user_id;
  ...
  getTalkText () {
    ...
    switch (this.resource.msg_type) {
      case 2:
        const file_type = this.resource.file.file_type;
  ...
  handle () {
    ...
    const isTrue = this.isTalk(this.talk_type, this.receiver_id, this.sender_id);
  ...
  showMessageNocice () {
    ...
    const talk_type = this.resource.talk_type;
  ...
  addTalkItem () {
    ...
    const talk_type = this.talk_type;
